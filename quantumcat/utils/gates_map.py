...
quantumcat_to_braket = {
    ...
    # OpType.dcx_gate: DCXGate,
    # OpType.ch_gate :CHGate,
    # OpType.crx_gate: CRXGate,
    # OpType.cry_gate: CRYGate,
    # OpType.crz_gate: CRZGate,
    # OpType.csx_gate: CSXGate,
    # OpType.cu_gate: CUGate,
    # OpType.cu1_gate: CU1Gate,
    # OpType.cu3_gate: CU3Gate,
    # OpType.MCXGate
    # OpType.MCXGrayCode
    # MCXRecursive
    # MCXVChain
    # OpType.MSGate
    # OpType.rccx_gate: RCCXGate,
    # OpType.rc3x_gate: RC3XGate,
    # OpType.r_gate: RGate,
    # OpType.rzx_gate: RZXGate,
